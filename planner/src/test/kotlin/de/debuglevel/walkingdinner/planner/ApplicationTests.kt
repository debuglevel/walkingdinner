...
import de.debuglevel.walkingdinner.planner.Application.main
...
class ApplicationTests {
    ...
    fun `standalone startup`() {
        // Arrange
        main(arrayOf())
        val port = MicronautUtils.getPort(de.debuglevel.walkingdinner.planner.Application.applicationContext)
